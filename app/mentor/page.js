...
function Mentorship() {
  ...
  const [openChatMentor, setOpenChatMentor] = useState(null);
  ...
  return (
    <>
      ...
      <div className="container bg-yellow-700 mx-auto mt-10 rounded-lg rounded-b-2xl flex-grow mb-20 px-7  pb-10 py-10 text-white">
        {/* Title and Field Selection */}
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
          <div className="p-4">
            <h1 className="text-5xl  font-bold">Mentorship & Counseling</h1>
            <p className="text-lg mt-4">
              Get personalized guidance from industry experts and experienced
              mentors. <br />
              Whether you're seeking career advice, technical support, or
              personal development, our mentorship program is here to help.
            </p>
          </div>
          <div className="p-4 ">
        ...
        {selectedField && (
          <div className="mt-8">
            <h2 className="text-2xl font-semibold">
              Available Mentors in {selectedField}
            </h2>
            <input
              type="text"
...
{openChatMentor && (
  <MentorChat userId={1} mentorId={openChatMentor.id} onClose={handleCloseChat} />
)}
